...
export default function SecretCode({ onUnlock }) {
  ...
  const secretCode = "143" // You can change this for portfolio or keep fun
      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="relative z-10 text-center space-y-8">
            ...
            >
              <Lock className="w-full h-full text-pink-400 drop-shadow-lg" />
            ...
            <div className="space-y-3">
              ...
              >
                Enter the code to unlock the next section
              </motion.p>
              <p className="text-white/50 text-sm">
                Hint: Use a fun number 😉
              </p>
            </div>
