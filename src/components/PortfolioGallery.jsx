    ...
    >
      <div className="w-full max-w-4xl flex flex-col justify-center space-y-8 md:space-y-12">
        ...
        >
          ...
          >
            A glimpse into my graphic design projects✨
          </motion.p>
        </motion.div>
        ...
        {onComplete && (
          <motion.div className="text-center mt-6">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onComplete}
              className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 md:px-10 py-4 rounded-full font-semibold text-base md:text-lg shadow-lg hover:shadow-xl transition-all duration-300"
            >
              View Contact
            </motion.button>
          </motion.div>
