...
export default function SpecialMessage({ onComplete }) {
  ...
  const fullMessage = `Hi, I'm Tafseer Anees 👋

I am a passionate Graphics Designer & Frontend Developer. I love crafting beautiful digital experiences, from sleek interfaces to engaging visuals.
...
Scroll down to see my work and get in touch! 💻✨`
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex flex-col justify-center text-white px-4 py-4 md:px-6 md:py-6 bg-gradient-to-br from-purple-900 via-black/40 to-pink-950/20"
    >
      <motion.div
        initial={{ y: 0 }}
